...
OUTPUT_FIELDNAMES = [
    ...
    "Upstream_Downstream_A_PH_cKVA",
    "Upstream_Downstream_B_PH_cKVA",
    "Upstream_Downstream_C_PH_cKVA",
    "Upstream_Total_Downstream_3PH_cKVA",
    "Downstream_Downstream_A_PH_cKVA",
    "Downstream_Downstream_B_PH_cKVA",
    "Downstream_Downstream_C_PH_cKVA",
    "Downstream_Total_Downstream_3PH_cKVA",
    "Notes",
]
...
def check_circuit(circuit: str, cyme_path: Path,
    ...
    for equip_num, d_row in devices.items():
        ...
        violations.append({
            ...
            "Upstream_Downstream_A_PH_cKVA":    u_row.get("Downstream A PH cKVA", ""),
            "Upstream_Downstream_B_PH_cKVA":    u_row.get("Downstream B PH cKVA", ""),
            "Upstream_Downstream_C_PH_cKVA":    u_row.get("Downstream C PH cKVA", ""),
            "Upstream_Total_Downstream_3PH_cKVA": u_row.get("Total downstream 3PH cKVA", ""),
            "Downstream_Downstream_A_PH_cKVA":  d_row.get("Downstream A PH cKVA", ""),
            "Downstream_Downstream_B_PH_cKVA":  d_row.get("Downstream B PH cKVA", ""),
            "Downstream_Downstream_C_PH_cKVA":  d_row.get("Downstream C PH cKVA", ""),
            "Downstream_Total_Downstream_3PH_cKVA": d_row.get("Total downstream 3PH cKVA", ""),
            "Notes":                            "; ".join(notes),
        })
